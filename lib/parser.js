...
var Parser = module.exports = function(lexer, opts) {
  opts = opts || {};
...
Parser.prototype._peek = function() { return this._peeked || (this._peeked = this.lexer.nextToken()); };
...
Parser.prototype._error = function(msg, line, col, pos) {
  // var ctx = S.input.context();
  // js_error(msg,
  //    line != null ? line : ctx.tokline,
  //    col != null ? col : ctx.tokcol,
  //    pos != null ? pos : ctx.tokpos);
  throw new Error(msg + " at line " + this.lexer._line + ", column " + this.lexer._col);
};
      ...
      switch (this._prog1(this._token.value, this._next)) {
        ...
        case "do":
          ...
          return (function(body){
            ...
            return this._node(Node.DO, self._prog1(self._parenthesised, self._semicolon), body);
...
Parser.prototype._node = function(type) {
  ...
  node.line = this._prevToken.line;
  return node;
}
