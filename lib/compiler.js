...
var Compiler = module.exports = function(source, opts) {
  ...
  this._outFunc = opts._outFunc || "_ajs.out";
  this._cbFunc = opts.argFung || "_ajs.cb";
  this._endFunc = opts.endFunc || "_ajs.end";
  this._lineFunc = opts.lineFunc || "_ajs.ln";
...
Compiler.prototype.compile = function() {
  ...
  this.compiled = this._make(this.tree) + "; " + this._endFunc + "();";
...
Compiler.prototype._blockStatements = function (statements) {
  for (var a = [], last = statements.length - 1, i = 0; i <= last; ++i) {
    ...
    if(this._lineFunc && stat.line != this.line && stat.children[0].type != Node.STRING) {
      code = this._lineFunc + "(" + stat.line + ");\n"  + code;
      this.line = stat.line;
    }
