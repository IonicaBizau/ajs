...
AJS.compileFile = AJS._load = function load(filename, opts, callback) {
...
// Synchronous version of AJS._load, used for require() support
AJS.compileFileSync = AJS._loadSync = function loadSync(filename, opts) {
  opts = opts || {};
