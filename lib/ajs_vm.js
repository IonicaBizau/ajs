...
AjsVM.prototype._write = function(data) {
  ...
  if(this._outBuffer.length > 5 || this._atEnd())
    this._flush();
}
...
AjsVM.prototype.run = function(source, options) {
  ...
  local._.extend(this.context.Nope, options.register);
...
AjsVM.createContext = function() {
  var context = {'Nope': {}};
  local._.extend(context.Nope, AjsVM._registered);
